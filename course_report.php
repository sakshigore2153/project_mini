...
.style12 {font-size: 24px; font-weight: bold; color: #000000; }
...
<table width="1180" height="275" border="1" align="center" bordercolor="#FF99CC">
  <tr>
    ...
    <td width="366"><p>&nbsp;</p>
      ...
      <tr>
        <td height="52"><div align="center" class="style3">Veiw All Course </div></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<p>&nbsp;</p>
<p align="center" class="style14">Course </p>
<form action="insertcourse.php" method="post" >
  <table width="838" border="1" align="center">
    <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
      <td><div align="center" class="style12">Course ID </div></td>
      <td><div align="center" class="style40 style8 style13"><strong><span class="style37 ">Course Name</span></strong></div></td>
      <td><div align="center" class="style40 style8 style13"><strong><span class="style36">Course Description</span></strong></div></td>
      <td><div align="center" class="style8 style40 style13"><strong><span class="style37">Course Fee </span></strong></div></td>
    </tr>
			<?php
		...
		while ($res = $query->fetch_assoc()) {
			...
			echo "<td>".$res['coursedescription']."</td>";
