...
$collagea=$_POST['collagea'];
$mothert=$_POST['mothert'];
...
$fno=$_POST['fno'];
$mno1=$_POST['mno1'];
$localgurdain=$_POST['localgurdain'];
$gurdainadd=$_POST['gurdainadd'];
$gurdainrelationship=$_POST['gurdainrelationship'];
$gurdainno=$_POST['gurdaino'];
...
$seatno=$_POST['seatno'];
$marksystem=$_POST['marksystem'];
$prevcourse=$_POST['prevcourse'];
$precoursename=$_POST['prevcoursename'];
$institutename=$_POST['institutename'];
$university1=$_POST['university1'];
$passingmonth=$_POST['passingmontht'];
$passingyear=$_POST['passingyear'];
$seatno1=$_POST['seatno1'];
$residance=$_POST['residance'];
$attempt=$_POST['attempt'];
$marksystem1=$_POST['marksystem1'];
$udias=$_POST['udias'];
...
$qry="INSERT INTO `addmissionform`(`acadmic`, `name`, `fname`, `surname`, `mno`, `cast`, `religion`,`category`, `nationality`, `collagea`, `mothert`, `placebirth`, `datebirth`, `bankpassbook`,`bankname`, `branch`, `accountno`, `ifscode`, `fathern`, `mothern`, `annualincome`,`foccupation`, `moccupation`, `fno`, `mno1`, `localgurdain`, `gurdainadd`, `gurdainrelationship`,`gurdaino`, `peraddress`, `percountry`, `perstate`, `percity`, `perarea`, `perpincode`,`address2`,`address`, `examname`,`university`, `institutename1`, `month`,`year`, `precentage`, `seatno`, `marksystem`,`prevcourse`, `precoursename`, `institutename`, `university1`,`passingmonth`, `passingyear`, `seatno1`, `residance`,`attempt`, `marksystem1`, `udias`,`eligibility`, `prnno`) VALUES('$acadmic', '$name','$fname','$surname','$mno','$cast', '$religion','$category','$nationality','$collagea','$mothert','$placebirth','$datebirth','$bankpassbook','$bankname','$branch','$accountno','$ifscode','$fathern', '$mothern','$annualincome','$foccupation', '$moccupation', '$fno', '$mno1','$localgurdain', '$gurdainadd','$gurdainrelationship','$gurdaino','$peraddress','$percountry', '$perstate','$percity','$perarea','$perpincode','$address2','$address','$examname','$university','$institutename1','$month','$year', '$precentage','$seatno', '$marksystem','$prevcourse','$precoursename','$institutename','$university1','$passingmonth','$passingyear','$seatno1','$residance','$attempt','$marksystem1', '$udias','$eligibilitys','$prnno')";
*/

$qry="INSERT INTO `addmission`(`acadamic`,`course`,`name`, `fname`, `surname` ,`mno`, `cast`, `religion`,`category`, `nationality`, `collagea`, `mothert`, `placebirth`, `datebirth`, `bankpassbook`,`bankname`, `branch`,`accountno`, `ifscode`, `fathern`, `mothern`, `annualincome`,`foccupation`, `moccupation`, `fno`, `mno1`,`localgurdain`,`gurdainadd`, `gurdainrelationship`,`gurdaino`, `peraddress`, `percountry`,`perstate`,`percity`,`perarea`,`perpincode`,`address`, `examname`,`university`, `institutename1`, `month`,`year`, `precentage`, `seatno`, `marksystem`,`prevcourse`, `precoursename`, `institutename`, `university1`,`passingmonth`, `passingyear`, `seatno1`, `residance`,`attempt`, `marksystem1`, `udias`,`eligibility`, `prnno`,`status`)VALUES('$acadmic','$course','$name','$fname','$surname','$mno','$cast', '$religion','$category','$nationality','$collagea','$mothert','$placebirth','$datebirth','$bankpassbook','$bankname','$branch','$accountno','$ifscode','$fathern', '$mothern','$annualincome','$foccupation', '$moccupation','$fno','$mno1','$localgurdain','$gurdainadd','$gurdainrelationship','$gurdaino','$peraddress','$percountry', '$perstate','$percity','$perarea','$pincode','$address','$examname','$university','$institutename1','$month','$year', '$precentage','$seatno', '$marksystem','$prevcourse','$precoursename','$institutename','$university1','$passingmonth','$passingyear','$seatno1','$residance','$attempt','$marksystem1', '$udias','$eligibilitys','$prnno','$status')";
$run=mysqli_query($con,$qry);
if($run==true)
{
	echo '<script>alert("Addmission Done Successfully...")</script>';
   echo '<script>window.location.href = "addmissionview.php";</script>';
}
else
{
  echo '<script>alert("Addmission Error...")</script>';
