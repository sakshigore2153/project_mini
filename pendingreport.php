...
<h2><b><p align="center" class="style2">Pending Student Rport </p><b></h2>
<?php
include("../database/dbcon.php");

// Fetch data in descending order (lastest entry first)
$sql = "SELECT acadamic,course,name,precentage,prevcourse,status FROM addmission where status='pending'";
$query= $con->query($sql);
$con->close();
?>
