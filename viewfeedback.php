...
$sql = "SELECT * FROM feedback ORDER BY f_id ASC";
 $query= $con->query($sql);
?>
...
<p>&nbsp;</p>
<p align="center">&nbsp;</p>
<h2><p align="center" class="style4">View Student Feedback </p></h2>
<table width="590" height="52" border="1" align="center">
  <tr>
    <td width="159"><div align="center" class="style3">F_ID</div></td>
    <td width="150"><div align="center"><span class="style3">Full Name </span></div></td>
    <td width="114"><div align="center" class="style3">EMail ID</div></td>
    <td width="139"><div align="center"><span class="style3">Feedback</span></div></td>
  </tr>
