...
?>
	<form action="pay.php" name="priceCalc" method="POST">
	<tr >
<th><font color="black">
  <label>
...
<th><p align="center">I Am Paying For :
  ...
  <p align="center" class="style4">Aahar card no:- 
...
$qry="INSERT INTO `pay`(`coursename`,`coursefee`,`name`,`email`,`aadar`,`card_type`,`card_Number`,`exp_date`,`CVV`) VALUES('$coursename','$coursefee','$name','$email','$aadar','$card_type','card_Number','$exp_date','$CVV')";
