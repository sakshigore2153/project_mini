...
.style33 {color: #000000; font-style: italic; font-weight: bold; font-size: 24px; }
.style42 {color: #660033}
.style43 {font-size: 36px; font-weight: bold; color: #660033; }
-->
</style>
</head>
...
<table width="1366" height="527">
  <tr>
    <td width="805" height="521"><img src="../image/com4.jpg" width="792" height="271" />
      <table width="803" height="316">
        <tr>
          <td width="823"><table width="697" height="258">
            <tr>
              <td width="348" height="252"><img src="../image/com2.jpg" width="397" height="305" /></td>
              <td width="337"><img src="../image/com3.jpg" width="388" height="304" /></td>
            </tr>
            </table></td>
        </tr>
    </table></td><td width="549" class="style33"><table width="537" height="368">
      <tr>
        <td width="529" align="center"><span class="style43">Computer Lab </span></td>
      </tr>
      <tr>
        <td height="284"><p align="justify">With the emergence of Information Technology in India, the want for computer savvy experts is being felt even in the legal world. As the knowledge and research sources are shifting from conventional library to computer lab, it is essential for every college to provide students with the best possible facilities.</p>
          <p align="justify">Asian Law College offers ultra modern highly equipped computer laboratory with advanced state of the art equipment. The computer lab is connected with 10 Mbps leased line internet connection, latest software,  The networking facilities are both through LAN as well as Wi-Fi connectivity.</p>
          <p align="justify" class="style42">Time: 07:00AM to 04:30PM</p></td>
      </tr>
    </table></td>
  </tr>
</table>
<table width="1339" height="527">
