...
$sql = "SELECT * FROM pay ORDER BY p_id ASC";
 $query= $con->query($sql);
?>
...
<p align="center" class="style2">View Payment </p>
<table width="1138" border="1" align="center" bgcolor="#CCCCCC">
  <tr>
    <td><div align="center" class="style3">P_id</div></td>
    <td><div align="center" class="style3">Couse Name </div></td>
    <td><div align="center" class="style3">Pay Fee </div></td>
    <td><div align="center" class="style3">Student Name </div></td>
    <td><div align="center" class="style3">Email </div></td>
    <td><div align="center" class="style3">Aadhar card no </div></td>
    <td><div align="center" class="style3">Card Type </div></td>
    <td><div align="center" class="style3">Expring Date</div></td>
    <td><div align="center" class="style3">Card Nunmber </div></td>
    <td><div align="center" class="style3">CVV</div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
	...
	<?php
		...
		while ($res = $query->fetch_assoc()) {
			...
			echo "<td>".$res['coursefee']."</td>";
			echo "<td>".$res['name']."</td>";
			echo "<td>".$res['email']."</td>";
			echo "<td>".$res['aadar']."</td>";
