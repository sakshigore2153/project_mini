...
$sql = "SELECT * FROM regi ORDER BY reg_id ASC";
 $query= $con->query($sql);
?>
  ...
  <tr>
    ...
    <td width="366"><p>&nbsp;</p>
      ...
      <table width="244" height="201" border="1" align="center" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
        ...
        <tr>
          <td><div align="center" class="style3"><a href="viewaddmission.php"> All Student Admission</a> </div></td>
        </tr>
        <tr>
...
<p>&nbsp;</p>
<p align="center">&nbsp;</p>
<h2><p align="center" class="style4">view student Report </p></h2>
<table width="1093" height="51" border="1" align="center">
  <tr>
    <td width="103"><div align="center" class="style3">R_id</div></td>
    <td width="107"><div align="center" class="style3">Student name </div></td>
    <td width="107"><div align="center" class="style3">Address</div></td>
    <td width="111"><div align="center" class="style3">M_Number</div></td>
    <td width="104"><div align="center" class="style3">Email</div></td>
    <td width="109"><div align="center" class="style3">City</div></td>
    <td width="71"><div align="center" class="style3">course</div></td>
    <td width="98"><div align="center" class="style3">Password</div></td>
    <td width="202"><div align="center" class="style3">ConfirmPassword</div></td>
  </tr>
    				<?php
