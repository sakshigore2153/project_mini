...
<h2><b><p align="center" class="style2">B.COM Student Report </p></b></h2>
<?php
include("../database/dbcon.php");

// Fetch data in descending order (lastest entry first)
$sql = "SELECT acadamic,course,name,precentage,prevcourse,status FROM addmission where course='BCOM'";
$query= $con->query($sql);
$con->close();
?>
