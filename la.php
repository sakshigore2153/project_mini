...
<p>&nbsp;</p>
      ...
      <p align="center" class="style28"><a href="../admin/admindash.php">Admin Login..</a></p>
      <p>&nbsp;</p>
    <p>&nbsp;</p></td>
  </tr>
</table>
...
$email = $_POST['email'];	
...

  {
    if(admin==$username && admin==$password)  
    {
        ...
        echo '<script>window.location.href = "admindah.php";</script>';
    }
  } 
  	       echo '<script>alert("Invalid Details")</script>';
   			echo '<script>window.location.href = "la.php";</script>'; 
}
?>
